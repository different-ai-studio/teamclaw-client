...
enum GroupedEvent: Identifiable {
...
/// Groups runs of 3+ consecutive completed tool_use events into a single
/// collapsible summary bar, skipping over thinking/tool_result that naturally
/// appear between tool calls. Matches the iOS grouping logic 1:1.
func groupEvents(_ events: [AgentEvent]) -> [GroupedEvent] {
