...
/// Upstream: clients → daemon (agent-level, sent to agent/{agentId}/commands topic)
public struct Amux_CommandEnvelope: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Amux_DeviceCommandEnvelope: Sendable {
  ...
  fileprivate var _command: Amux_DeviceCollabCommand? = nil
}
...
/// Device-level collab events (flow through {deviceId}/collab topic)
public struct Amux_DeviceCollabEvent: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var event: Amux_DeviceCollabEvent.OneOf_Event? = nil

  public var peerJoined: Amux_PeerJoined {
    get {
      if case .peerJoined(let v)? = event {return v}
      return Amux_PeerJoined()
    }
    set {event = .peerJoined(newValue)}
  }

  public var peerLeft: Amux_PeerLeft {
    get {
      if case .peerLeft(let v)? = event {return v}
      return Amux_PeerLeft()
    }
    set {event = .peerLeft(newValue)}
  }

  public var peerKicked: Amux_PeerKicked {
    get {
      if case .peerKicked(let v)? = event {return v}
      return Amux_PeerKicked()
    }
    set {event = .peerKicked(newValue)}
  }

  public var memberListChanged: Amux_MemberListChanged {
    get {
      if case .memberListChanged(let v)? = event {return v}
      return Amux_MemberListChanged()
    }
    set {event = .memberListChanged(newValue)}
  }

  public var authResult: Amux_AuthResult {
    get {
      if case .authResult(let v)? = event {return v}
      return Amux_AuthResult()
    }
    set {event = .authResult(newValue)}
  }

  public var inviteCreated: Amux_InviteCreated {
    get {
      if case .inviteCreated(let v)? = event {return v}
      return Amux_InviteCreated()
    }
    set {event = .inviteCreated(newValue)}
  }

  public var commandRejected: Amux_PromptRejected {
    get {
      if case .commandRejected(let v)? = event {return v}
      return Amux_PromptRejected()
    }
    set {event = .commandRejected(newValue)}
  }

  public var workspaceResult: Amux_WorkspaceResult {
    get {
      if case .workspaceResult(let v)? = event {return v}
      return Amux_WorkspaceResult()
    }
  ...
  public enum OneOf_Event: Equatable, Sendable {
    case peerJoined(Amux_PeerJoined)
    case peerLeft(Amux_PeerLeft)
    case peerKicked(Amux_PeerKicked)
    case memberListChanged(Amux_MemberListChanged)
    case authResult(Amux_AuthResult)
...
public struct Amux_PeerJoined: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Amux_PeerLeft: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Amux_PeerKicked: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Amux_MemberListChanged: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Amux_AuthResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// Device-level collab commands (sent to {deviceId}/collab topic)
public struct Amux_DeviceCollabCommand: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var command: Amux_DeviceCollabCommand.OneOf_Command? = nil

  public var peerAnnounce: Amux_PeerAnnounce {
    get {
      if case .peerAnnounce(let v)? = command {return v}
      return Amux_PeerAnnounce()
    }
    set {command = .peerAnnounce(newValue)}
  }

  public var peerDisconnect: Amux_PeerDisconnect {
    get {
      if case .peerDisconnect(let v)? = command {return v}
      return Amux_PeerDisconnect()
    }
    set {command = .peerDisconnect(newValue)}
  }

  public var inviteMember: Amux_InviteMember {
    get {
      if case .inviteMember(let v)? = command {return v}
      return Amux_InviteMember()
    }
    set {command = .inviteMember(newValue)}
  }

  public var removeMember: Amux_RemoveMember {
    get {
      if case .removeMember(let v)? = command {return v}
      return Amux_RemoveMember()
    }
    set {command = .removeMember(newValue)}
  }

  public var addWorkspace: Amux_AddWorkspace {
    get {
      if case .addWorkspace(let v)? = command {return v}
      return Amux_AddWorkspace()
    }
    set {command = .addWorkspace(newValue)}
  }

  public var removeWorkspace: Amux_RemoveWorkspace {
    get {
      if case .removeWorkspace(let v)? = command {return v}
      return Amux_RemoveWorkspace()
    }
    set {command = .removeWorkspace(newValue)}
  }

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  public enum OneOf_Command: Equatable, Sendable {
    case peerAnnounce(Amux_PeerAnnounce)
    case peerDisconnect(Amux_PeerDisconnect)
    case inviteMember(Amux_InviteMember)
    case removeMember(Amux_RemoveMember)
    case addWorkspace(Amux_AddWorkspace)
    case removeWorkspace(Amux_RemoveWorkspace)
...
public struct Amux_WorkspaceResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Amux_PeerDisconnect: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Amux_InviteMember: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// Response to InviteMember
public struct Amux_InviteCreated: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Amux_DeviceCommandEnvelope: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Amux_DeviceCommandEnvelope, rhs: Amux_DeviceCommandEnvelope) -> Bool {
    if lhs.deviceID != rhs.deviceID {return false}
    if lhs.peerID != rhs.peerID {return false}
    if lhs.commandID != rhs.commandID {return false}
    if lhs.timestamp != rhs.timestamp {return false}
...
extension Amux_AcpToolUse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}tool_id\0\u{3}tool_name\0\u{1}description\0\u{1}params\0")
...
extension Amux_DeviceCollabEvent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: Amux_PeerJoined?
        var hadOneofValue = false
        if let current = self.event {
          hadOneofValue = true
          if case .peerJoined(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.event = .peerJoined(v)
        }
      }()
      case 2: try {
        var v: Amux_PeerLeft?
        ...
        if let current = self.event {
          hadOneofValue = true
          if case .peerLeft(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.event = .peerLeft(v)
        }
      }()
      case 3: try {
        var v: Amux_PeerKicked?
        var hadOneofValue = false
        if let current = self.event {
          hadOneofValue = true
          if case .peerKicked(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.event = .peerKicked(v)
        }
      }()
      case 4: try {
        var v: Amux_MemberListChanged?
        var hadOneofValue = false
        if let current = self.event {
          hadOneofValue = true
          if case .memberListChanged(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.event = .memberListChanged(v)
        }
      }()
      case 5: try {
        var v: Amux_AuthResult?
        var hadOneofValue = false
        if let current = self.event {
          hadOneofValue = true
        ...
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.event = .authResult(v)
        }
      }()
      case 6: try {
        var v: Amux_InviteCreated?
        var hadOneofValue = false
        if let current = self.event {
          hadOneofValue = true
          if case .inviteCreated(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.event = .inviteCreated(v)
        }
      }()
      case 7: try {
        var v: Amux_PromptRejected?
        ...
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.event = .commandRejected(v)
        }
      }()
      case 8: try {
        var v: Amux_WorkspaceResult?
        var hadOneofValue = false
        if let current = self.event {
          hadOneofValue = true
          if case .workspaceResult(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    switch self.event {
    case .peerJoined?: try {
      guard case .peerJoined(let v)? = self.event else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    }()
    case .peerLeft?: try {
      guard case .peerLeft(let v)? = self.event else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
    }()
    case .peerKicked?: try {
      guard case .peerKicked(let v)? = self.event else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
    }()
    case .memberListChanged?: try {
      guard case .memberListChanged(let v)? = self.event else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
    }()
    case .authResult?: try {
      guard case .authResult(let v)? = self.event else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 5)
    }()
    case .inviteCreated?: try {
      guard case .inviteCreated(let v)? = self.event else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 6)
    }()
    case .commandRejected?: try {
      guard case .commandRejected(let v)? = self.event else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 7)
    }()
    ...
    if !self.deviceID.isEmpty {
      try visitor.visitSingularStringField(value: self.deviceID, fieldNumber: 10)
    }
    if self.timestamp != 0 {
  ...
  public static func ==(lhs: Amux_DeviceCollabEvent, rhs: Amux_DeviceCollabEvent) -> Bool {
    if lhs.deviceID != rhs.deviceID {return false}
    if lhs.timestamp != rhs.timestamp {return false}
    if lhs.event != rhs.event {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
...
extension Amux_PeerJoined: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PeerJoined"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}peer\0")
  ...
  public static func ==(lhs: Amux_PeerJoined, rhs: Amux_PeerJoined) -> Bool {
...
extension Amux_PeerLeft: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PeerLeft"
  ...
  public static func ==(lhs: Amux_PeerLeft, rhs: Amux_PeerLeft) -> Bool {
    if lhs.peerID != rhs.peerID {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Amux_PeerKicked: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PeerKicked"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}peer_id\0\u{1}reason\0")
  ...
  public static func ==(lhs: Amux_PeerKicked, rhs: Amux_PeerKicked) -> Bool {
    if lhs.peerID != rhs.peerID {return false}
    if lhs.reason != rhs.reason {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Amux_MemberListChanged: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".MemberListChanged"
  ...
  public static func ==(lhs: Amux_MemberListChanged, rhs: Amux_MemberListChanged) -> Bool {
...
extension Amux_AuthResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".AuthResult"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}peer_id\0\u{1}accepted\0\u{1}reason\0\u{1}role\0")
  ...
  public static func ==(lhs: Amux_AuthResult, rhs: Amux_AuthResult) -> Bool {
    if lhs.peerID != rhs.peerID {return false}
...
extension Amux_DeviceCollabCommand: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".DeviceCollabCommand"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}peer_announce\0\u{3}peer_disconnect\0\u{3}invite_member\0\u{3}remove_member\0\u{3}add_workspace\0\u{3}remove_workspace\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: Amux_PeerAnnounce?
        var hadOneofValue = false
        if let current = self.command {
          hadOneofValue = true
          if case .peerAnnounce(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.command = .peerAnnounce(v)
        }
      }()
      case 2: try {
        var v: Amux_PeerDisconnect?
        var hadOneofValue = false
        if let current = self.command {
          hadOneofValue = true
          if case .peerDisconnect(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.command = .peerDisconnect(v)
        }
      }()
      case 3: try {
        var v: Amux_InviteMember?
        var hadOneofValue = false
        if let current = self.command {
          hadOneofValue = true
        ...
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.command = .inviteMember(v)
        }
      }()
      case 4: try {
        var v: Amux_RemoveMember?
        var hadOneofValue = false
        if let current = self.command {
          hadOneofValue = true
        ...
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.command = .removeMember(v)
        }
      }()
      case 5: try {
        var v: Amux_AddWorkspace?
        var hadOneofValue = false
        if let current = self.command {
          hadOneofValue = true
        ...
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.command = .addWorkspace(v)
        }
      }()
      case 6: try {
        var v: Amux_RemoveWorkspace?
        var hadOneofValue = false
        if let current = self.command {
          hadOneofValue = true
        ...
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.command = .removeWorkspace(v)
        }
      }()
      default: break
      }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    // https://github.com/apple/swift-protobuf/issues/1182
    switch self.command {
    case .peerAnnounce?: try {
      guard case .peerAnnounce(let v)? = self.command else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    }()
    case .peerDisconnect?: try {
      guard case .peerDisconnect(let v)? = self.command else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
    }()
    case .inviteMember?: try {
      guard case .inviteMember(let v)? = self.command else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
    }()
    case .removeMember?: try {
      guard case .removeMember(let v)? = self.command else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
    }()
    case .addWorkspace?: try {
      guard case .addWorkspace(let v)? = self.command else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 5)
    }()
    case .removeWorkspace?: try {
      guard case .removeWorkspace(let v)? = self.command else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 6)
    }()
    case nil: break
    }
  ...
  public static func ==(lhs: Amux_DeviceCollabCommand, rhs: Amux_DeviceCollabCommand) -> Bool {
    if lhs.command != rhs.command {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Amux_WorkspaceResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkspaceResult"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}command_id\0\u{1}success\0\u{1}error\0\u{1}workspace\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeSingularMessageField(value: &self._workspace) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Amux_WorkspaceResult, rhs: Amux_WorkspaceResult) -> Bool {
    if lhs.commandID != rhs.commandID {return false}
    if lhs.success != rhs.success {return false}
...
extension Amux_PeerDisconnect: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PeerDisconnect"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  public static func ==(lhs: Amux_PeerDisconnect, rhs: Amux_PeerDisconnect) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Amux_InviteCreated: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".InviteCreated"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}request_id\0\u{3}invite_token\0\u{1}deeplink\0\u{3}expires_at\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularStringField(value: &self.deeplink) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.deeplink.isEmpty {
      try visitor.visitSingularStringField(value: self.deeplink, fieldNumber: 3)
    }
    if self.expiresAt != 0 {
  ...
  public static func ==(lhs: Amux_InviteCreated, rhs: Amux_InviteCreated) -> Bool {
    if lhs.requestID != rhs.requestID {return false}
