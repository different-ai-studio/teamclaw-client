...
extension Amux_AcpStartAgent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}agent_type\0\u{1}worktree\0\u{3}initial_prompt\0")
...
extension Amux_DeviceCollabEvent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}peer_joined\0\u{3}peer_left\0\u{3}peer_kicked\0\u{3}member_list_changed\0\u{3}auth_result\0\u{3}invite_created\0\u{3}command_rejected\0\u{4}\u{3}device_id\0\u{1}timestamp\0")
...
extension Amux_DeviceCollabCommand: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}peer_announce\0\u{3}peer_disconnect\0\u{3}invite_member\0\u{3}remove_member\0")
...
extension Amux_AgentInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}agent_id\0\u{3}agent_type\0\u{1}worktree\0\u{1}branch\0\u{1}status\0\u{3}started_at\0\u{3}current_prompt\0")
